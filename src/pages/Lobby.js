...
const GAMES = [
  ...
  { id: 'rummy', suit: '♥', name: 'Rummy', desc: 'Gin Rummy against smart bots. Sign in to play.', players: '2–4 players', status: 'live', color: '#c0392b', path: '/game/rummy', learnPath: '/learn/rummy', requiresAuth: true },
