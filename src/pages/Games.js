...
const games = [
  { name: 'Container Tycoon', desc: 'Build a global shipping empire. Buy ships, open trade routes, dominate the seas.', path: '/game/container-tycoon', emoji: '🚢' },
  { name: 'Spades',           desc: 'Bid, bluff and take tricks. Play solo against bots.',                              path: '/game/spades',           emoji: '♠' },
  { name: 'Solitaire',        desc: 'Classic single-player card game. Simple and relaxing.',                            path: '/game/solitaire',        emoji: '🃏' },
  { name: 'Rummy',            desc: 'Form sets and sequences. Play live against real opponents.',                        path: '/game/rummy',            emoji: '♥' },
  { name: 'Bridge',           desc: 'Rubber and Duplicate formats. Bot opponents available.',                            path: '/game/bridge',           emoji: '♦' },
  { name: 'Teen Patti',       desc: 'Three variants — Classic, AK47 and Muflis.',                                       path: '/game/teen-patti',       emoji: '♣' },
];
