    ...
    <div style={s.page}>
      <div style={s.inner}>
        ...
        <p style={s.body}>
          ...
          No download, no install — just open your browser and play Bridge, Rummy, Teen Patti, or Solitaire
          against real opponents from anywhere in the world. We built this because great card games deserve
          a great home online: fast, clean, and available in multiple languages so every player feels at home.
        </p>
        <hr style={s.divider} />
        <div style={s.stat}>
          <div style={s.statBox}>
